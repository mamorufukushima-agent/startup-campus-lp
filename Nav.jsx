    ...
    <nav style={navStyle}>
      <div className="container" style={{
        ...
        <a href="#top" className="nav-brand" style={{ display: "flex", alignItems: "center", gap: 10, textDecoration: "none", color: "var(--ink-900)", flexShrink: 0 }}>
          <img className="nav-logo" src="assets/logo-color.png" alt="Startup Campus" style={{ height: 44, width: "auto" }}/>
      ...
      <div className={"mobile-menu" + (menuOpen ? " open" : "")}>
        {items.map(i => (
          <a key={i.href} href={i.href} onClick={closeMenu}>{i.label}</a>
        ))}
        <a href="https://startupcampus.work/contact/" target="_blank" rel="noopener" onClick={closeMenu}>
          お問い合わせ →
        </a>
      </div>
    </nav>
